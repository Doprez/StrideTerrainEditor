...
namespace SinglePassWireframe
{
    public class SinglePassWireframeRenderFeature : RootRenderFeature
    {
        ...
        protected override void InitializeCore()
        {
            ...
            pipelineState.State.InputElements = VertexTypePosTexNormColor.Layout.CreateInputElements();
        ...
        public override void Draw(RenderDrawContext context, RenderView renderView, RenderViewStage renderViewStage)
        {
            ...
            foreach (var renderNode in renderViewStage.SortedRenderNodes)
            {
                ...
                //this is a major trick that allows us to do everything 
                //at runtime, attach the WireframeScript script to a created
                //entity in code and go
                ModelComponent mod = renderMesh.Source as ModelComponent;
                //the terrain mesh Entity is given this name when created
                if (mod.Entity.Name != "TerrainComponentModelComponent")
                {
                    continue;
                }
                // get wireframe script
                WireframeScript wireframeScript = mod.Entity.Get<WireframeScript>();
