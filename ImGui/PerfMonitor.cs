...
namespace ImGui
{
    ...
    {
        public static bool show_PerfMonitorGUI;
...
namespace ImGui
{
    ...
    public class PerfMonitor : BaseWindow
    {
     ...
     //   protected override Vector2? WindowPos => 
     //       new Vector2(Game.GraphicsContext.CommandList.Viewport.Width/ 2.0f, 55);
     //   protected override Vector2? WindowSize => new Vector2(320f, 240f);
        protected override ImGuiWindowFlags WindowFlags => ImGuiWindowFlags.NoTitleBar;
